...
scan_config_record::scan_config_record ( const scan_config_record& config )
{
    ...
    scan_config_export_format_typeid = config.scan_config_export_format_typeid;
...
guint scan_config_record::get_scan_config_export_format_typeid()
{
    return scan_config_export_format_typeid;
}

void scan_config_record::get_scan_config_unique_barcodes ( bool value )
{
...
void scan_config_record::get_scan_config_items_per_container ( guint value )
{
...
void scan_config_record::get_scan_config_barcode_length_min ( guint value )
{
...
void scan_config_record::get_scan_config_barcode_length_max ( guint value )
{
...
void scan_config_record::get_scan_config_container_prefix ( Glib::ustring value )
{
...
void scan_config_record::get_scan_config_container_suffix ( Glib::ustring value )
{
...
void scan_config_record::get_scan_config_container_autoincrement ( bool value )
{
...
void scan_config_record::get_scan_config_container_autoprint ( bool value )
{
...
void scan_config_record::get_scan_config_export_format_typeid ( guint value )
{
    scan_config_export_format_typeid = value;
